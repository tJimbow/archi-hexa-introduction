...
<ul>
    <li class="fragment"><strong>Adapteurs de port Driven</strong> : Implementation Ports <em>Driven</em>
        <ul>
            <li>Toujours avec une préfixe qui indique la techno utilisée.</li>
            <li class="fragment">Toujours avec le suffixe « Adapter » pour indiquer comme un port <em>driven</em>.</li>
            <li class="fragment">Il faut qu'un adapteur implemente au moins d'un port <em>driven</em>.</li>
    ...
    <li class="fragment"><strong>Adapteurs de port Driving</strong> : Implementation Ports <em>Driving</em>
        <ul>
            <li>Nom basé sur le nom d'interfaces sans « I ».</li>
            <li class="fragment">Jamais avec le suffixe « Adapter » pour indiquer comme un port <em>driving</em>.</li>
