...
<ul>
  ...
  <li class="fragment">✅ Ne connaît <strong>pas</strong> l'implémentation concrète du port secondaire</li>
  <li class="fragment">✅ Peut contenir l'implémentation du port primaire</li>
